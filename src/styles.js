...
export const S = {
  ...
  btnPrimary: { width: "100%", maxWidth: 320, background: "#1a1a2e", color: "#F5F0E8", fontWeight: 700, fontSize: 16, padding: "16px 20px", borderRadius: 14, display: "flex", alignItems: "center", justifyContent: "center", gap: 8, boxShadow: "0 4px 14px rgba(26,26,46,0.2)", border: "none", cursor: "pointer" },
  btnSecondary: { width: "100%", background: "#fff", border: "1px solid #E8E5DC", color: "#1a1a2e", fontWeight: 600, fontSize: 14, padding: "13px 18px", borderRadius: 11, display: "flex", alignItems: "center", justifyContent: "center", gap: 8, cursor: "pointer" },
  btnGhost: { background: "transparent", border: "1px solid #E8E5DC", color: "#9a8f7e", fontWeight: 500, fontSize: 13, padding: "11px 16px", borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", gap: 8, cursor: "pointer" },
  ...
  header: { borderBottom: "1px solid var(--border-passage)", padding: "10px 20px", display: "flex", justifyContent: "space-between", alignItems: "center", position: "fixed", top: 0, left: 0, right: 0, zIndex: 40 },
  ...
  body: { maxWidth: "95%", margin: "0 auto", padding: "24px 18px", paddingTop: "86px" },
  ...
  backBtn: { background: "var(--bg-card)", border: "1px solid var(--border-passage)", borderRadius: 9, padding: "7px 9px", display: "flex", alignItems: "center", color: "var(--text-sec)", boxShadow: "0 1px 3px rgba(0,0,0,0.05)", cursor: "pointer" },
